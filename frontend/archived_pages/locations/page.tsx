      ...
      <section className="pt-32 pb-20 px-6 relative">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <p className="text-xl text-gray-700 mb-12 max-w-3xl mx-auto leading-relaxed">
            WAGA DAO operates in two strategic locations across Africa, each with unique challenges and opportunities
        ...
        <div className="container mx-auto max-w-6xl relative">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <Card className="bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 hover:rotate-1 group overflow-hidden">
              ...
              <CardContent className="p-8 relative z-10">
                <div className="flex items-center mb-6">
                  <MapPin className="h-8 w-8 text-amber-600 mr-4 transition-transform duration-300 group-hover:scale-125" />
                  <div>
                    <h3 className="text-3xl font-bold text-amber-700">Bamendakwe, Cameroon</h3>
                    <p className="text-amber-600">Post-Conflict Development Zone</p>
                  </div>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center text-gray-700">
                    ...
                    <span>1,200+ farmers to be supported</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <Mountain className="h-5 w-5 text-amber-600 mr-3" />
                    <span>Highland agroforestry systems</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <Factory className="h-5 w-5 text-amber-600 mr-3" />
                    <span>New processing infrastructure</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <Calendar className="h-5 w-5 text-amber-600 mr-3" />
                    <span>3-year development timeline</span>
                  </div>
                </div>

                <div className="bg-amber-100/50 rounded-lg p-4 mb-6">
                  <h4 className="font-semibold text-amber-800 mb-2">Key Challenges</h4>
                  <ul className="text-sm text-amber-700 space-y-1">
                    <li>• Post-conflict infrastructure rebuilding</li>
                    <li>• Youth engagement and retention</li>
                    <li>• Market access development</li>
                    <li>• Technical capacity building</li>
                  </ul>
                </div>

                <div className="bg-amber-100/50 rounded-lg p-4">
                  <h4 className="font-semibold text-amber-800 mb-2">Our Approach</h4>
                  <ul className="text-sm text-amber-700 space-y-1">
                    <li>• Complete value chain development</li>
                    <li>• Youth-focused training programs</li>
                    <li>• Cooperative formation support</li>
                    <li>• Digital traceability integration</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 hover:-rotate-1 group overflow-hidden">
              ...
              <CardContent className="p-8 relative z-10">
                <div className="flex items-center mb-6">
                  <MapPin className="h-8 w-8 text-green-600 mr-4 transition-transform duration-300 group-hover:scale-125" />
                  <div>
                    <h3 className="text-3xl font-bold text-green-700">Highland Ethiopia</h3>
                    <p className="text-green-600">Established Coffee Region</p>
                  </div>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center text-gray-700">
                    ...
                    <span>2,800+ existing farmers</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <Coffee className="h-5 w-5 text-green-600 mr-3" />
                    <span>Premium arabica varieties</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <TrendingUp className="h-5 w-5 text-green-600 mr-3" />
                    <span>Immediate scaling potential</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <Calendar className="h-5 w-5 text-green-600 mr-3" />
                    <span>18-month integration timeline</span>
                  </div>
                </div>

                <div className="bg-green-100/50 rounded-lg p-4 mb-6">
                  <h4 className="font-semibold text-green-800 mb-2">Key Opportunities</h4>
                  <ul className="text-sm text-green-700 space-y-1">
                    <li>• Established cooperative networks</li>
                    <li>• High-quality coffee production</li>
                    <li>• Existing processing infrastructure</li>
                    <li>• Strong farmer organization</li>
                  </ul>
                </div>
                ...
                <div className="bg-green-100/50 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-green-700 space-y-1">
                    <li>• Digital integration and traceability</li>
                    <li>• Quality premium programs</li>
                    <li>• Direct trade relationships</li>
                    <li>• Blockchain certification</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Phased approach to sustainable development</p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-amber-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group">
              <CardContent className="p-8">
                <div className="flex items-start space-x-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-amber-400 to-amber-600 rounded-2xl flex items-center justify-center flex-shrink-0 transition-all duration-300 group-hover:scale-110">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-2xl font-bold text-amber-700">Foundation Phase</h3>
                    </div>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        <h4 className="font-semibold text-amber-800 mb-2">Cameroon</h4>
                        <ul className="text-gray-700 space-y-1 text-sm">
                          <li>• Community engagement and mapping</li>
                          <li>• Cooperative formation workshops</li>
                          <li>• Land assessment and planning</li>
                          <li>• Initial infrastructure design</li>
                        </ul>
                      </div>
                      <div>
                        <h4 className="font-semibold text-green-800 mb-2">Ethiopia</h4>
                        <ul className="text-gray-700 space-y-1 text-sm">
                          <li>• MOU signing with cooperatives</li>
                          <li>• Baseline quality assessment</li>
                          <li>• Digital system integration</li>
                          <li>• Traceability pilot program</li>
                        </ul>
                      </div>
                    </div>
                  </div>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-green-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group">
              <CardContent className="p-8">
                <div className="flex items-start space-x-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-green-400 to-green-600 rounded-2xl flex items-center justify-center flex-shrink-0 transition-all duration-300 group-hover:scale-110">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-2xl font-bold text-green-700">Development Phase</h3>
                    </div>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        <h4 className="font-semibold text-amber-800 mb-2">Cameroon</h4>
                        <ul className="text-gray-700 space-y-1 text-sm">
                          <li>• Nursery establishment</li>
                      ...
                      <div>
                        ...
                        <ul className="text-gray-700 space-y-1 text-sm">
                          ...
                          <li>• Quality premium rollout</li>
                          <li>• Direct buyer connections</li>
                          <li>• First certified batches</li>
                        </ul>
                      </div>
                    </div>
                  </div>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-emerald-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group">
              <CardContent className="p-8">
                <div className="flex items-start space-x-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-2xl flex items-center justify-center flex-shrink-0 transition-all duration-300 group-hover:scale-110">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-2xl font-bold text-emerald-700">Production Phase</h3>
                    </div>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        <h4 className="font-semibold text-amber-800 mb-2">Cameroon</h4>
                        <ul className="text-gray-700 space-y-1 text-sm">
                          <li>• First harvest processing</li>
                          <li>• Quality certification</li>
                          <li>• Market entry strategy</li>
                          <li>• Cooperative sustainability</li>
                        </ul>
                      </div>
                      <div>
                        <h4 className="font-semibold text-green-800 mb-2">Ethiopia</h4>
                        <ul className="text-gray-700 space-y-1 text-sm">
                          ...
                          <li>• Revenue sharing implementation</li>
                          <li>• Model replication planning</li>
                        </ul>
                      </div>
                    </div>
                  </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-white/60 via-green-50/60 to-emerald-100/80 relative">
        ...
        <div className="container mx-auto max-w-6xl relative">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Combined results across both locations</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="bg-white/80 backdrop-blur-sm border-amber-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 group">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-3xl font-bold text-amber-600 mb-2">4,000+</div>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-green-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 group">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-sm text-gray-600">Tons Coffee/Year</div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-emerald-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 group">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-3xl font-bold text-emerald-600 mb-2">$195M</div>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-blue-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 group">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-sm text-gray-600">Hectares Regenerated</div>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-12 shadow-2xl border border-emerald-200">
            ...
            <p className="text-xl text-gray-700 mb-8">
              Help us build sustainable coffee economies in Cameroon and Ethiopia
            </p>
