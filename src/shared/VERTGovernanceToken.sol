 ...
 */
contract VERTGovernanceToken is ERC20, ERC20Votes, ERC20Permit, Ownable, AccessControl, Pausable {
    ...
    error VERTGovernanceToken__TransferNotAllowed_update(address from, address to);
