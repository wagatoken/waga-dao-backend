...
export default function About() {
  const keyFacts = [
    ...
    },
    {
      icon: Users,
      title: "Impact",
      description: "Supporting 10,000+ farmers with $2.8M in disbursed grants and milestone tracking"
    },
    {
      icon: Coffee,
      title: "Technology",
      description: "Smart contracts on Arbitrum with IPFS storage and gold-backed treasury"
    }
  ]
      ...
      <nav className="fixed top-0 w-full z-50 bg-black/20 backdrop-blur-xl border-b border-white/10">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-6">
            ...
            <Link href="/grants" className="text-white/80 hover:text-white transition-colors">
              Grants
            </Link>
            <Link href="/treasury" className="text-white/80 hover:text-white transition-colors">
              Treasury
            </Link>
