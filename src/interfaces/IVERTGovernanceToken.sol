...
/**
 * @title IVERTGovernanceToken
 * @dev Interface for the WAGA Vertical Integration Token (VERT) with minting capabilities
 * @author WAGA DAO - Regenerative Coffee Global Impact
 */
interface IVERTGovernanceToken is IERC20 {
