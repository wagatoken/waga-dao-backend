...
/**
 * @title GreenfieldProjectManager
 ...
 */
contract GreenfieldProjectManager is AccessControl, Pausable {
    ...
    error GreenfieldProjectManager__InvalidProject();
    error GreenfieldProjectManager__InvalidStage();
    error GreenfieldProjectManager__InvalidDates();
    error GreenfieldProjectManager__InvalidYield();
    error GreenfieldProjectManager__ProjectNotFound();
